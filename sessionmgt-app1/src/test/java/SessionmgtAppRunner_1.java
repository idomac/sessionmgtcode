 ...
 * @author : lihaoquan
 */
public class SessionmgtAppRunner_1 {

    public static final int PORT = 9080;
    public static final String CONTEXT = "/sessionmgt-app1";
    public static final String[] TLD_JAR_NAMES
            = new String[] { "sitemesh", "spring-webmvc", "shiro-web" };

    public static final String DEFAULT_WEBAPP_PATH = "sessionmgt-app1/src/main/webapp";
