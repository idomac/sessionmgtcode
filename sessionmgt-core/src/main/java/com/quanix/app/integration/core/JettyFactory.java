...
public class JettyFactory {
    ...
    private static final String WINDOWS_WEBDEFAULT_PATH = "sessionmgt-core/src/main/resources/jetty/webdefault-windows.xml";

    /**
     * 创建用于开发运行调试的Jetty Server, 以src/main/webapp为Web应用目录.
     */
    public static Server createServerInSource(String webppPath, int port, String contextPath) {
        ...
        WebAppContext webContext = new WebAppContext(webppPath, contextPath);
